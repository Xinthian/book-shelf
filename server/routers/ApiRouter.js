...
class ApiRouter {
  ...
  init() {
    ...
    this.router.get('/me/ebook-annotations/:libraryItemId', MeController.getEbookAnnotations.bind(this))
    ...
    this.router.post('/me/ebook-annotations/:libraryItemId', MeController.createEbookAnnotation.bind(this))
    this.router.patch('/me/ebook-annotations/:libraryItemId/:annotationId', MeController.updateEbookAnnotation.bind(this))
    this.router.delete('/me/ebook-annotations/:libraryItemId/:annotationId', MeController.removeEbookAnnotation.bind(this))
